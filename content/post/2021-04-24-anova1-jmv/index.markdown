...
Notice how both ANOVA outputs provide the same F ratio, degrees of freedom, and a p values. The difference is that a plot of the means and confidence intervals is not automatically generated. To produce a similar plot, a little more effort will be required.
