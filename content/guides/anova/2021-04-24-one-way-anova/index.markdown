...
The following code chunk displays how to use the `anovaOneW()` function to analyze the same data and get the same results, although this example uses the `tukey` post hoc test correction method.
